    ...
    <div className="flex items-center gap-2">
      ...
      >
        <select
          ...
          aria-label="Document"
          className="rounded-lg border border-control bg-white px-2.5 py-1.5 text-xs font-medium text-slate-700 transition hover:border-control-strong focus-ring disabled:opacity-50"
        >
      ...
      >
        <button
          onClick={onGenerate}
          disabled={disabled}
          className="rounded-lg border border-control bg-white px-2.5 py-1.5 text-xs font-medium text-slate-500 transition hover:border-control-strong hover:text-slate-700 disabled:opacity-40"
        >
          Generate
        </button>
      </Tooltip>
